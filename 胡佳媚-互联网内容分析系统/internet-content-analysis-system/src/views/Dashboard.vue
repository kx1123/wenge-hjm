      ...
      <div class="dashboard-header">
        ...
        <div class="header-right">
          <n-space>
            ...
            <n-tag v-if="latestItem" type="info" :bordered="false" size="large">
              <span class="tag-icon">⚡</span>
              <span>最新: {{ latestItem.type === 'webmedia' ? '网媒' : '微博' }}</span>
              <span v-if="latestItem.isNew" class="new-badge-header">NEW</span>
            </n-tag>
          </n-space>
        </div>
      </div>
...
const latestItem = computed(() => simulator.latestItem.value)
